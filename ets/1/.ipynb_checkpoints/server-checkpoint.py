...
alldata = dict()
alldata['1']=dict(nomor=1, nama="Ter Stegen")
alldata['2']=dict(nomor=2, nama="Marcelo")
alldata['3']=dict(nomor=3, nama="Gerrad Pique")
alldata['4']=dict(nomor=4, nama="Sergio Ramos")
alldata['5']=dict(nomor=5, nama="Sergio Busquets")
alldata['6']=dict(nomor=6, nama="Xavi Hernandez")
alldata['7']=dict(nomor=7, nama="Cristiano Ronaldo")
alldata['8']=dict(nomor=8, nama="Andres Iniesta")
alldata['9']=dict(nomor=9, nama="Karim Benzema")
alldata['10']=dict(nomor=10, nama="Lionel Messi")
alldata['11']=dict(nomor=11, nama="Neymar Jr")
alldata['12']=dict(nomor=12, nama="Mohammad Salah")
alldata['13']=dict(nomor=13, nama="Claudio Bravo")
alldata['14']=dict(nomor=14, nama="Javier Hernandez")
alldata['15']=dict(nomor=15, nama="Pedri")
alldata['16']=dict(nomor=16, nama="Gavi")
alldata['17']=dict(nomor=17, nama="Pedro")
alldata['18']=dict(nomor=18, nama="Bruno Fernandes")
alldata['19']=dict(nomor=19, nama="Raphael Varane")
alldata['20']=dict(nomor=20, nama="Diogo Dalot")
